...
- Kimi K2.7 Code uses official `kimi-k2.7-code` pricing: cache hit `$0.19`, cache miss `$0.95`, output `$4.00`, with a `262,144` token context window and automatic context caching.
