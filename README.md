...
- DeepSeek V4 Flash and V4 Pro use the current official `deepseek-v4-flash` and `deepseek-v4-pro` prices. `deepseek-v4-flash` now routes to DeepSeek-V4-Flash-0731. DeepSeek notes that the `deepseek-chat` and `deepseek-reasoner` compatibility aliases were deprecated on `2026-07-24 15:59 UTC`. The current pricing page warns that overall DeepSeek API prices are expected to rise significantly in the near future; the specific pricing plan remains subject to official notice.
