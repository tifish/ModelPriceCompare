...
- Rechecked the official pricing and current-model pages. Updated Gemini 3.6 Flash to its current Standard promotional price through `2026-12-31`; no newly eligible models or other direct Standard/global token-price changes were found.
