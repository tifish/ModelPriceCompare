...
- Rechecked the official pricing and current-model pages. No newly eligible models or direct Standard/global token-price changes were found; DeepSeek's new weekend off-peak rule is reflected below.
