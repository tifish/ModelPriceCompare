...
| GLM-5.3-Flash | Z.AI | $0.03 | 10.71x | $0.15 | 1.07x | $0.5 | 1.79x | Standard API list price |
...
| GLM-5.3-FlashX | Z.AI | $0.075 | 26.79x | $0.37 | 2.64x | $1.25 | 4.46x | Standard API |
...
- Rechecked official sources on 2026-09-21: No confirmed USD token-price changes or eligible new models; all 47 price rows are retained. Clarified that DeepSeek bills Chinese public holidays at off-peak rates throughout the day. The CNY conversion rate remains `1 USD = 6.7080 CNY`. Kimi per-model pricing URLs still redirect to an overview without price tables, and GLM-5-Turbo is absent from Z.AI pricing; these five rows retain previous values marked `unverified`.
