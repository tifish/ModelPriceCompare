...
所有价格统一为人民币约价 / 1M tokens。除提供方直接列出人民币价格的情况外，美元价格按 `1 USD = 6.7686 CNY` 近似换算。倍率按每个价格类别分别计算，以该类别中最便宜的模型作为 `1.00x`；在本次模型列表中，DeepSeek V4 Flash 和 Xiaomi MiMo-V2.5 共同作为缓存命中输入、缓存未命中输入与输出基准。
...
| Xiaomi MiMo-V2.5-Pro | Xiaomi MiMo | ¥0.024 | 1.29x | ¥2.94 | 3.11x | ¥5.89 | 3.11x | 海外 API，V2.5 降价后价格 |
| DeepSeek V4 Pro | DeepSeek | ¥0.025 | 1.29x | ¥2.94 | 3.11x | ¥5.89 | 3.11x | 当前标准 API |
| GPT-5.4 Nano | OpenAI | ¥0.14 | 7.14x | ¥1.35 | 1.43x | ¥8.46 | 4.46x | 标准 API 短上下文 |
| Gemini 3.1 Flash-Lite | Google | ¥0.17 | 8.93x | ¥1.69 | 1.79x | ¥10.15 | 5.36x | 付费 Standard，文本/图像/视频 |
| GPT-5.4 Mini | OpenAI | ¥0.51 | 26.79x | ¥5.08 | 5.36x | ¥30.46 | 16.07x | 标准 API 短上下文 |
| Gemini 3.5 Flash | Google | ¥1.02 | 53.57x | ¥10.15 | 10.71x | ¥60.92 | 32.14x | 付费 Standard 档 |
| Kimi K2.6 | Moonshot AI / Kimi | ¥1.08 | 57.14x | ¥6.43 | 6.79x | ¥27.07 | 14.29x | 标准 API |
| Kimi K2.7 Code | Moonshot AI / Kimi | ¥1.29 | 67.86x | ¥6.43 | 6.79x | ¥27.07 | 14.29x | 标准 API |
| GLM-5 | Z.AI | ¥1.35 | 71.43x | ¥6.77 | 7.14x | ¥21.66 | 11.43x | 标准 API |
| Gemini 3.1 Pro Preview（<=200K prompts） | Google | ¥1.35 | 71.43x | ¥13.54 | 14.29x | ¥81.22 | 42.86x | 付费 Standard，<=200K prompts 档 |
| GLM-5-Turbo | Z.AI | ¥1.62 | 85.71x | ¥8.12 | 8.57x | ¥27.07 | 14.29x | 标准 API |
| GPT-5.4（短上下文） | OpenAI | ¥1.69 | 89.29x | ¥16.92 | 17.86x | ¥101.53 | 53.57x | 标准 API，输入 <=272K tokens |
| GLM-5.1 | Z.AI | ¥1.76 | 92.86x | ¥9.48 | 10.00x | ¥29.78 | 15.71x | 标准 API |
| GLM-5.2 | Z.AI | ¥1.76 | 92.86x | ¥9.48 | 10.00x | ¥29.78 | 15.71x | 标准 API |
| Kimi K2.7 Code HighSpeed | Moonshot AI / Kimi | ¥2.57 | 135.71x | ¥12.86 | 13.57x | ¥54.15 | 28.57x | HighSpeed API |
| Gemini 3.1 Pro Preview（>200K prompts） | Google | ¥2.71 | 142.86x | ¥27.07 | 28.57x | ¥121.83 | 64.29x | 付费 Standard，>200K prompts 档 |
| Claude Opus 4.7 | Anthropic | ¥3.38 | 178.57x | ¥33.84 | 35.71x | ¥169.22 | 89.29x | Claude API 全球路由 |
| Claude Opus 4.8 | Anthropic | ¥3.38 | 178.57x | ¥33.84 | 35.71x | ¥169.22 | 89.29x | Claude API 全球路由 |
| GPT-5.4（长上下文） | OpenAI | ¥3.38 | 178.57x | ¥33.84 | 35.71x | ¥152.29 | 80.36x | 标准 API，输入 >272K tokens |
| GPT-5.5（短上下文） | OpenAI | ¥3.38 | 178.57x | ¥33.84 | 35.71x | ¥203.06 | 107.14x | 标准 API，输入 <=272K tokens |
| Claude Fable 5 | Anthropic | ¥6.77 | 357.14x | ¥67.69 | 71.43x | ¥338.43 | 178.57x | Claude API 全球路由 |
| Claude Mythos 5 | Anthropic | ¥6.77 | 357.14x | ¥67.69 | 71.43x | ¥338.43 | 178.57x | Claude API 全球路由，limited availability |
| GPT-5.5（长上下文） | OpenAI | ¥6.77 | 357.14x | ¥67.69 | 71.43x | ¥304.59 | 160.71x | 标准 API，输入 >272K tokens |
## 重要说明
