...
| DeepSeek V4.1 Flash (off-peak) | DeepSeek | ¥0.02 | 1.07x | ¥1.01 | 1.07x | ¥4.02 | 2.14x | Standard API off-peak |
...
| DeepSeek V4 Pro (off-peak) | DeepSeek | ¥0.15 | 7.86x | ¥4.43 | 4.71x | ¥13.28 | 7.07x | Standard API off-peak |
| Gemini 3.1 Flash-Lite | Google | ¥0.17 | 8.93x | ¥1.68 | 1.79x | ¥10.06 | 5.36x | Standard paid tier text/image/video |
| GLM-5.3-Flash | Z.AI | ¥0.20 | 10.71x | ¥1.01 | 1.07x | ¥3.35 | 1.79x | Standard API list price |
| Gemini 3.5 Flash-Lite | Google | ¥0.20 | 10.71x | ¥2.01 | 2.14x | ¥16.77 | 8.93x | Standard paid tier text/image/video/audio |
| GPT-5.6 Luna（长上下文） | OpenAI | ¥0.27 | 14.29x | ¥2.68 | 2.86x | ¥12.07 | 6.43x | Standard API >272K input tokens |
| DeepSeek V4 Pro (peak) | DeepSeek | ¥0.30 | 15.71x | ¥8.85 | 9.43x | ¥26.56 | 14.14x | Standard API peak |
| GPT-5.4 Mini | OpenAI | ¥0.50 | 26.79x | ¥5.03 | 5.36x | ¥30.19 | 16.07x | Standard API short context |
| Gemini 3.6 Flash | Google | ¥0.50 | 26.79x | ¥5.03 | 5.36x | ¥25.16 | 13.39x | Standard paid tier promotional price through 2026-12-31 |
| Gemini 3.7 Flash | Google | ¥0.50 | 26.79x | ¥5.03 | 5.36x | ¥25.16 | 13.39x | Standard paid tier promotional price through 2026-12-31 |
| Gemini 3.8 Flash | Google | ¥0.50 | 26.79x | ¥5.03 | 5.36x | ¥25.16 | 13.39x | Standard paid tier introductory price through 2026-12-31 |
| GLM-5.3-FlashX | Z.AI | ¥0.50 | 26.79x | ¥2.48 | 2.64x | ¥8.39 | 4.46x | Standard API |
| Gemini 3.5 Flash | Google | ¥1.01 | 53.57x | ¥10.06 | 10.71x | ¥60.37 | 32.14x | Standard paid tier |
| Kimi K2.6 | Moonshot AI / Kimi | ¥1.07 | 57.14x | ¥6.37 | 6.79x | ¥26.83 | 14.29x | unverified - previous Standard API |
| Kimi K2.7 Code | Moonshot AI / Kimi | ¥1.27 | 67.86x | ¥6.37 | 6.79x | ¥26.83 | 14.29x | unverified - previous Standard API |
| GLM-5 | Z.AI | ¥1.34 | 71.43x | ¥6.71 | 7.14x | ¥21.47 | 11.43x | Standard API |
| Claude Sonnet 5 | Anthropic | ¥1.34 | 71.43x | ¥13.42 | 14.29x | ¥67.08 | 35.71x | Standard Claude API global routing |
| GPT-5.6 Terra（短上下文） | OpenAI | ¥1.34 | 71.43x | ¥13.42 | 14.29x | ¥80.50 | 42.86x | Standard API <=272K input tokens |
| Gemini 3.1 Pro Preview (<=200K prompts) | Google | ¥1.34 | 71.43x | ¥13.42 | 14.29x | ¥80.50 | 42.86x | Standard paid tier <=200K prompts |
| GLM-5-Turbo | Z.AI | ¥1.61 | 85.71x | ¥8.05 | 8.57x | ¥26.83 | 14.29x | unverified - previous Standard API |
| GPT-5.4（短上下文） | OpenAI | ¥1.68 | 89.29x | ¥16.77 | 17.86x | ¥100.62 | 53.57x | Standard API <=272K input tokens |
| Claude Fable 5.1 | Anthropic | ¥1.68 | 89.29x | ¥67.08 | 71.43x | ¥335.40 | 178.57x | Standard Claude API global routing |
| Claude Mythos 5.1 | Anthropic | ¥1.68 | 89.29x | ¥67.08 | 71.43x | ¥335.40 | 178.57x | Standard Claude API global routing |
| GLM-5.1 | Z.AI | ¥1.74 | 92.86x | ¥9.39 | 10.00x | ¥29.52 | 15.71x | Standard API |
| GLM-5.2 | Z.AI | ¥1.74 | 92.86x | ¥9.39 | 10.00x | ¥29.52 | 15.71x | Standard API |
| GLM-5.3 | Z.AI | ¥1.74 | 92.86x | ¥9.39 | 10.00x | ¥29.52 | 15.71x | Standard API |
| Kimi K3 | Moonshot AI / Kimi | ¥2.01 | 107.14x | ¥20.12 | 21.43x | ¥100.62 | 53.57x | unverified - previous Standard API |
| Kimi K2.7 Code HighSpeed | Moonshot AI / Kimi | ¥2.55 | 135.71x | ¥12.75 | 13.57x | ¥53.66 | 28.57x | unverified - previous HighSpeed API |
| GPT-5.6 Sol（短上下文） | OpenAI | ¥2.68 | 142.86x | ¥26.83 | 28.57x | ¥134.16 | 71.43x | Standard API promotional price <=272K input tokens |
| GPT-5.6 Terra（长上下文） | OpenAI | ¥2.68 | 142.86x | ¥26.83 | 28.57x | ¥120.74 | 64.29x | Standard API >272K input tokens |
| Gemini 3.1 Pro Preview (>200K prompts) | Google | ¥2.68 | 142.86x | ¥26.83 | 28.57x | ¥120.74 | 64.29x | Standard paid tier >200K prompts |
| Claude Opus 4.7 | Anthropic | ¥3.35 | 178.57x | ¥33.54 | 35.71x | ¥167.70 | 89.29x | Standard Claude API global routing |
| Claude Opus 4.8 | Anthropic | ¥3.35 | 178.57x | ¥33.54 | 35.71x | ¥167.70 | 89.29x | Standard Claude API global routing |
| Claude Opus 5 | Anthropic | ¥3.35 | 178.57x | ¥33.54 | 35.71x | ¥167.70 | 89.29x | Standard Claude API global routing |
| GPT-5.4（长上下文） | OpenAI | ¥3.35 | 178.57x | ¥33.54 | 35.71x | ¥150.93 | 80.36x | Standard API >272K input tokens |
| GPT-5.5（短上下文） | OpenAI | ¥3.35 | 178.57x | ¥33.54 | 35.71x | ¥201.24 | 107.14x | Standard API <=272K input tokens |
| GPT-5.6 Sol（长上下文） | OpenAI | ¥5.37 | 285.71x | ¥53.66 | 57.14x | ¥201.24 | 107.14x | Standard API promotional price >272K input tokens |
| Claude Fable 5 | Anthropic | ¥6.71 | 357.14x | ¥67.08 | 71.43x | ¥335.40 | 178.57x | Standard Claude API global routing |
| Claude Mythos 5 | Anthropic | ¥6.71 | 357.14x | ¥67.08 | 71.43x | ¥335.40 | 178.57x | Standard Claude API global routing limited availability |
| GPT-5.5（长上下文） | OpenAI | ¥6.71 | 357.14x | ¥67.08 | 71.43x | ¥301.86 | 160.71x | Standard API >272K input tokens |
| GPT-6 Astra（短上下文） | OpenAI | ¥6.71 | 357.14x | ¥67.08 | 71.43x | ¥335.40 | 178.57x | Standard API <=272K input tokens |
| GPT-6 Astra（长上下文） | OpenAI | ¥13.42 | 714.29x | ¥134.16 | 142.86x | ¥503.10 | 267.86x | Standard API >272K input tokens |

## 重要说明

- 本次于 2026-09-22 复核官方来源：未发现已确认的美元 token 单价变化或符合纳入条件的新模型，保留全部 47 条价格记录。人民币换算汇率仍为 `1 USD = 6.7080 CNY`。Kimi 模型专属价格仍无法核验（K3 跳转至不含价格表的总览页，K2.6 和 K2.7 Code 页面抓取失败），GLM-5-Turbo 未出现在当前 Z.AI 价格表中；这五行保留旧值并标为 `unverified`（待核验）。
