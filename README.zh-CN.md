...
| GPT-5.4（短上下文） | OpenAI | ¥16.94 | 17.86x | ¥1.69 | 89.29x | ¥101.65 | 53.57x | 标准 API，输入 <=272K tokens |
...
| GPT-5.4（长上下文） | OpenAI | ¥33.88 | 35.71x | ¥3.39 | 178.57x | ¥152.47 | 80.36x | 标准 API，输入 >272K tokens |
| Claude Opus 4.8 | Anthropic | ¥33.88 | 35.71x | ¥3.39 | 178.57x | ¥169.41 | 89.29x | Claude API 全球路由 |
| GPT-5.5（短上下文） | OpenAI | ¥33.88 | 35.71x | ¥3.39 | 178.57x | ¥203.29 | 107.14x | 标准 API，输入 <=272K tokens |
| GPT-5.5（长上下文） | OpenAI | ¥67.76 | 71.43x | ¥6.78 | 357.14x | ¥304.94 | 160.71x | 标准 API，输入 >272K tokens |

## 重要说明

- 汇率采用近似值 `1 USD = 6.7764 CNY`。该汇率取自 Exchange-Rates.org 在 `2026-06-08 13:00 UTC` 给出的 USD/CNY 汇率；实际账单以服务商结算币种和付款时汇率为准。
