...
| GPT-5.6 Sol （短上下文） | OpenAI | ¥2.70 | 142.86x | ¥26.96 | 28.57x | ¥134.82 | 71.43x | 标准 API 促销价，输入 <=272K tokens |
...
| GPT-5.6 Sol （长上下文） | OpenAI | ¥5.39 | 285.71x | ¥53.93 | 57.14x | ¥202.24 | 107.14x | 标准 API 促销价，输入 >272K tokens |
