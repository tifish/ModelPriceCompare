...
所有价格统一为人民币约价 / 1M tokens。除提供方直接列出人民币价格的情况外，美元价格按 `1 USD = 6.95 CNY` 近似换算。倍率按每个价格类别分别计算，以该类别中最便宜的模型作为 `1.00x`；在本次模型列表中，DeepSeek V4 Flash 在缓存命中输入、非命中输入、输出三个类别中都是基准。

| 模型 | 提供方 | 输入缓存命中 | 命中倍率 | 输入缓存未命中 | 未命中倍率 | 输出 | 输出倍率 | 价格口径 |
|---|---:|---:|---:|---:|---:|---:|---:|---|
| DeepSeek V4 Flash | DeepSeek | ¥0.19 | 1.00x | ¥0.97 | 1.00x | ¥1.95 | 1.00x | 当前标准 API |
| DeepSeek V4 Pro | DeepSeek | ¥0.25 | 1.29x | ¥3.02 | 3.11x | ¥6.05 | 3.11x | 当前限时折扣价 |
| Kimi K2.6 | Moonshot AI / Kimi | ¥1.11 | 5.71x | ¥6.60 | 6.79x | ¥27.80 | 14.29x | 标准 API |
| Xiaomi MiMo-V2.5-Pro | Xiaomi MiMo | ¥1.39 | 7.14x | ¥6.95 | 7.14x | ¥20.85 | 10.71x | 海外 API，<=256K tokens 档 |
| Gemini 3.1 Pro Preview | Google | ¥1.39 | 7.14x | ¥13.90 | 14.29x | ¥83.40 | 42.86x | 付费 Standard，<=200K prompts 档 |
| GLM-5.1 | Z.AI | ¥1.81 | 9.29x | ¥9.73 | 10.00x | ¥30.58 | 15.71x | 标准 API |
| GPT-5.4 | OpenAI | ¥1.74 | 8.93x | ¥17.38 | 17.86x | ¥104.25 | 53.57x | 标准短上下文 API |
| Claude Opus 4.6 | Anthropic | ¥3.48 | 17.86x | ¥34.75 | 35.71x | ¥173.75 | 89.29x | Claude API 全球路由 |
| Claude Opus 4.7 | Anthropic | ¥3.48 | 17.86x | ¥34.75 | 35.71x | ¥173.75 | 89.29x | Claude API 全球路由 |
| GPT-5.5 | OpenAI | ¥3.48 | 17.86x | ¥34.75 | 35.71x | ¥208.50 | 107.14x | 标准短上下文 API |
