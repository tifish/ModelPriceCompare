...
| Moonshot AI / Kimi | https://platform.kimi.ai/docs/pricing/chat | https://platform.kimi.ai/docs/models | 默认只纳入 Kimi 2.6 及以上。有模型专属价格页时，优先使用 `/docs/pricing/chat-k27-code`、`/docs/pricing/chat-k26` 这类页面。cache hit、cache miss 和 output 列按页面原样处理。 |
